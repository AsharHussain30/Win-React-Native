    ...
    return (
      ...
      <View style={{ paddingVertical: "5%", paddingHorizontal: "5%", backgroundColor: "#d60664" ,borderBottomLeftRadius:50,borderBottomRightRadius:50}}>
          ...
          <View style={{ shadowColor: "white", shadowRadius: 20, shadowOffset: { height: 2, width: 1, elevation: 5 } }}>
            <Image source={require('../assets/panda1.png')} style={{ height: 150, width: 100, display: "flex", marginHorizontal: 180, marginVertical: -45, }} />
          </View>
        </View>
        <View>
          <Searchbar placeholder='Find Your Food Here...' color="white" style={{ marginHorizontal: 20, borderRadius: 10, shadowRadius: 20, shadowColor: "white", shadowOffset: { height: 1, width: 1 }, elevation: 15, marginVertical: 30 }} />
        </View>
        <View>
          ...
          <ScrollView scrollEnabled horizontal showsHorizontalScrollIndicator={false}>
            <View style={styles.card1} >
              <TouchableOpacity>
                ...
                <Caption style={{ fontSize: 15, fontFamily: "JosefinSans_600SemiBold_Italic", textAlign: "center" }}>Burger</Caption>
          ...
          <ScrollView scrollEnabled horizontal showsHorizontalScrollIndicator={false}>
            <View style={styles.card1}>
              <TouchableOpacity>
                ...
                <Caption style={{ fontSize: 15, fontFamily: "JosefinSans_600SemiBold_Italic", textAlign: "center"  }}>PIZZA</Caption>
                <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                  <Text style={styles.forward1}><MaterialCommunityIcons name='cart' size={27} color="white" /></Text>
                  <Text style={{ textAlign: "right" }}><MaterialCommunityIcons name='arrow-right-bold-hexagon-outline' size={27} color='white' /></Text>
                </View>
